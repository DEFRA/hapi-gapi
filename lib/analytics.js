...
const getBatchInterval = () => process.env.HAPI_GAPI_BATCH_INTERVAL || 1
const getBatchSize = () => process.env.HAPI_GAPI_BATCH_SIZE || 1
...
module.exports = class Analytics {
  ...
  async send () {
    while (this._hitBuffer.length > 0) {
      console.log('this._hitBuffer: ', this._hitBuffer)
      ...
      wreck
        .request('post', 'https://www.google-analytics.com/batch/analytics/v3', {
          agent: this._agent,
          payload: payload,
          timeout: 0
        })
