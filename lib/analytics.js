...
module.exports = class Analytics {
  constructor ({
    ...
    console.log('this._agent', this._agent)
  }
  ...
  async hit (type, request, payload) {
    console.log('request', request.route.fingerprint)
    ...
    console.log('sending')
    await this.send(pagePath)
  }

  async send (measurementId, apiSecret, pagePath) {
