...
console.log('attributionSchema: ', attributionSchema)
...
module.exports = class Analytics {
  ...
  ga (request) {
    return {
      pageView: additionalPayload => this.hit('pageview', request, { t: 'pageview', ...additionalPayload }, console.log(additionalPayload)),
