...
exports.plugin = {
  ...
  register: async (server, options) => {
    ...
    console.log('register decorations: ', server.decorations)
    console.log('register views: ', server.views)
    ...
    server.ext('onPreResponse', async (request, h) => {
      ...
      if (shouldTrack) {
        ...
        if (statusFamily === 2 && response.variety === 'view') {
          ...
          console.log('analytics.ga.pageView: ', analytics.ga.pageView())
      ...
      console.log('analytics.ga: ', analytics.ga)
      return h.continue
    })
