...
This plugin decorates the request object so that you can easily send data to Google Analytics. With the migration to GA4 this package only sends basic pageview data with random client IDs. Done so with the the following function:
